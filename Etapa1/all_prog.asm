...
########################################
end_add:
	addiu	$sp,$sp,-4			# assume-se $sp inicializado, aloca espaço na pilha. Usamos 0x10010800.
	...
	addiu 	$sp,$sp,4 			# atualiza apontador de pilhaend:
	jr 		$ra 				# volta para o "sistema operacional" FIM DO PROGRAMA AQUI
...
ver_ev:
	lw 		$t3,0($sp) 			# tira dados to topo da pilha (parâmetro)
...
array:		.word 	0xabcdef03 0xcdefab18 0xefabcd35 0xbadcfeab 0xdcfebacd 0xfebadc77 0xdefabc53 0xcbafed45 #terceiro byte da segunda pala vra (0xef) vira 0x10 antes de exec soma_ct
size: 		.word 	0x8
const: 		.word 	0xffffffff
# constante -1 em complemento de 2
